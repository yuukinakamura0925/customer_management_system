      ...
      <v-layout row wrap justify-center>
        ...
        <v-flex sm3 mt-5>
          <v-card>
            <v-card-text>
              <v-form>
                <v-text-field v-model="name" :counter="20" :rules="[v => !!v || 'メニュー名を入力してください']" label="メニュー名" required ></v-text-field>
                <v-text-field v-model="price" :counter="10" :rules="[v => !!v || '値段を入力してください']" label="値段" required ></v-text-field>
                <p>
